...
# SARIMAX Commodity Price Forecasting (from Code 2)

from statsmodels.tsa.statespace.sarimax import SARIMAX

# Load dataset for SARIMAX
file_path = "https://raw.githubusercontent.com/laxmi-narayan-87/AgroValue/refs/heads/main/monthly_data.csv"  # Replace with your local file path
